...
Public Class frmEFL
    ...
    ' xyzzy scan server for initial user data
    Private Sub Reflect_Users()

        Dim item

        lstUsers.Items.Clear()
        If (FlowServer.ServerUsers.Count > 0) Then
            For Each item In FlowServer.ServerUsers
    ...
    Private Sub Reflect_Runs()
        ...
        If FlowServer.ServerUserRuns(mUser).Count > 0 Then
            For Each item In FlowServer.ServerUserRuns(mUser)
                ...
                If (FlowStructure.CurRun.ToLower = item.ToString.ToLower) Then lstRuns.SelectedIndex = lstRuns.Items.Count - 1
            Next
    ...
    Private Sub Reflect_Files()
        ...
        ' scan files in run
        If (FlowServer.ServerUserRun(mUser, FlowStructure.CurRun).Count > 0) Then
            For Each item In FlowServer.ServerUserRun(mUser, FlowStructure.CurRun)
    ...
    Private Sub Reflect_Download()
        ...
        Dim local_run = System.IO.Path.Combine(FlowStructure.Data_Root, FlowStructure.CurRun)
    ...
    Private Sub lstRuns_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstRuns.SelectedIndexChanged
        ...
        FlowStructure.CurRun = lstRuns.SelectedItem
    ...
    Private Sub cmdDownload_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDownload.Click
        ...
        FlowServer.Download_Run(mUser, FlowStructure.CurRun)
