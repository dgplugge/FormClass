...
Public Class frmReport
    ...
    Private Sub Extract_Keys()
        ...
        Dim file
        For Each file In System.IO.Directory.GetFiles(Report_Run.Orig_Path)
    ...
    Private mFormSize As System.Drawing.Size
    Private mDGSize As System.Drawing.Size

    ' dgp rev 5/19/09 Initialize Structure
    Private Function Init() As Boolean

        mFormSize = Me.Size
        mDGSize = dgvReport.Size

        If (System.IO.Path.GetFileName(Report_Run.Data_Path)).ToLower = "data" Then
    ...
    Private Sub frmReport_ResizeEnd(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.ResizeEnd

        Dim hdiff = Me.Size.Height - mFormSize.Height
        Dim hi = mDGSize.Height + hdiff

        dgvReport.Size = New Size(dgvReport.Size.Width, hi)
